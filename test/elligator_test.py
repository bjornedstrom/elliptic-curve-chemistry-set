...
def decodepoint_curve25519(s):
  x = sum(2**i * bit(s,i) for i in range(0,256-1))
  sign_bit = bit(s,255-1)
  return (x, sign_bit)
'''


# https://github.com/Yawning/libelligator/blob/master/src/tests/kat.cc
class Elligator2Test(unittest.TestCase):
    def setUp(self):
        self.curve25519 = asymmetric.ECC_Curve25519
        self.ell2 = elligator.Elligator2(self.curve25519.curve)

    def test_choice_of_non_square_for_curve25519(self):
        self.assertEquals(2, self.ell2.u)
